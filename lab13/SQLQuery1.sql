...
--2 Найти процедуру с помощью обозревателя объектов и через контекстное меню создать сценарий на изменение процедуры оператором ALTER.
-- Изменить процедуру, чтобы она принимала два параметра. 
